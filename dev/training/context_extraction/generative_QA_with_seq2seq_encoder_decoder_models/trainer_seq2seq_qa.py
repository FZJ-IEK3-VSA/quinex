...
class QuestionAnsweringSeq2SeqTrainer(Seq2SeqTrainer):
    ...
    def create_optimizer_and_scheduler(self, num_training_steps: int):
        """
        Overwrite the default method for being able to use Adafactor optimizer during hyperparameter search.
        """
        self.optimizer = Adafactor(self.model.parameters(), scale_parameter=False, relative_step=False, warmup_init=False, lr=self.args.learning_rate)
